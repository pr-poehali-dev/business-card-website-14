      ...
      <header className="fixed top-0 w-full bg-white/90 backdrop-blur-sm border-b border-border z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-secondary">Группа компаний "Капитал Сервис"</span>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Группа компаний "Капитал Сервис" — профессиональная компания по обслуживанию кассовой техники с многолетним опытом работы. Мы помогаем бизнесу соблюдать требования законодательства и обеспечиваем бесперебойную работу кассового оборудования.
              </p>
            ...
            <div className="animate-fade-in space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    г. Санкт-Петербург, ул. Даниила Хармса, дом 3, К. 1 литера А, пом. 11-Н
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+7 (969) 202-03-63</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
